using AVBridgeToSipUriSample.Common;
...
namespace AVBridgeToSipUriSample
{
    public class WebApiApplication : System.Web.HttpApplication
    {
        ...
        private void HandleIncomingAVCall(object sender, IncomingInviteEventArgs<IAudioVideoInvitation> args)
        {
            ...
            string  agent = ConfigurationManager.AppSettings["MyAgent"];

            var ae = sender as ApplicationEndpoint;
            var job = new AVBridgeToSipUriJob(args, agent);
            job.Start();
        }
    }
}
